...
export class Company {
  ...
  constructor(company_name?: string, language?: string, uid?: string, person_name?: string, domicile_address?: Address, correspondance_address?: Address,
   ...
   *
   */
  replace({company_name, language, uid, person_name, domicile_address, correspondance_address, phone, email, branch_structure, document_upload_enabled, documents}:
            {
              company_name: string, language: string, uid: string, person_name: string, domicile_address: Address, correspondance_address: Address,
              phone: string, email: string, branch_structure: boolean, document_upload_enabled: boolean, documents: Array<File>
            }): void {
