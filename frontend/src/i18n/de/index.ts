export default {
  ...
  authentication: {
    ...
    reset_password_text: 'Wir senden Ihnen per E-Mail einen Link zu, damit Sie Ihr Passwort zurücksetzen können',
  ...
  errors: {
    ...
    missing_user: 'Bitte geben sie einen gültigen Benutzernamen ein',
    identical_password: 'Passwörter müssen identisch sein',
  },
  set_password: {
