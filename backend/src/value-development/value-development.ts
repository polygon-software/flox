...
export async function getValueDevelopment(
  ...
  // return parseFloat((endValue / startValue).toFixed(4)); // TODO: Correct calculation after discussion with SOI
  return 1 + parseFloat(((endValue - startValue) / 100).toFixed(4));
}
