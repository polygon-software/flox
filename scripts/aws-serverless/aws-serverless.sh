# --------------------------------------------------------------
# Deploys the current state on of the system on AWS serverless
# Takes one parameter: deployment tag (e.g. 'dev', 'stage-1' etc.)
# --------------------------------------------------------------

if [[ $1 == "" ]]
then
  echo "No deployment mode given"
  exit
fi

echo "Deploying serverless in mode $1"
...
# ==      (so we can use subdomain)       ==
# == e.g. stage-1.flox.polygon-project.ch ==
# ==========================================
